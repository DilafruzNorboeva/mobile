...
import '/modules/hotel_details/review_data_view.dart';
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          LocalLanguage(context).of("summary"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: !isReadless
                              ? LocalLanguage(context).of("read_more")
                              : LocalLanguage(context).of("less"),
                ...
                Padding(
                  ...
                  child: CommonButton(
                    buttonText: LocalLanguage(context).of("book_now"),
                    onTap: () {
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
            child: Text(
              LocalLanguage(context).of(title),
              // "Photos",
              style: TextStyles(context).getBoldStyle().copyWith(
                    fontSize: 14,
                  ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          ...
                                          top: 16),
                                      child: CommonButton(
                                          buttonText: LocalLanguage(context)
                                              .of("book_now"),
                                          onTap: () {
                                            NavigationServices(context)
      ...
      children: <Widget>[
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      LocalLanguage(context).of("km_to_city"),
                      overflow: TextOverflow.ellipsis,
                      style: TextStyles(context).getRegularStyle().copyWith(
                            fontSize: 14,
                            color: isInList
                  ...
                  : Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text(
                            LocalLanguage(context).of("reviews"),
                            style:
                                TextStyles(context).getRegularStyle().copyWith(
                                      fontSize: 14,
                                      color: isInList
        ...
        Column(
          ...
          children: <Widget>[
            ...
            Text(
              LocalLanguage(context).of("per_night"),
              style: TextStyles(context).getRegularStyle().copyWith(
                    fontSize: 14,
                    color: isInList
                        ? Theme.of(context).disabledColor
