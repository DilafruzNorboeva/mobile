...
import '/modules/hotel_details/search_type_list.dart';
import '/modules/hotel_details/search_view.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            CommonAppbarView(
              ...
              titleText: LocalLanguage(context).of("search_hotel"),
            ),
            Expanded(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                child: Text(
                                  LocalLanguage(context).of("Last_search"),
